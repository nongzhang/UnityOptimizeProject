...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            // [SerializeField] internal int AOPassDownsampleValue = 4;
            // [SerializeField] internal int BlurPassDownsampleValue = 4;
            // [SerializeField] internal int FinalDownsampleValue = 4;
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                int downsampleDivider = m_CurrentSettings.Downsample ? 4 : 1;  //采样率变为1/4, URP默认为1/2

                // int AODownsampleDivider = m_CurrentSettings.Downsample ? AOPassDownsampleValue : 1;
                // int BlurDownsampleDivider = m_CurrentSettings.Downsample ? BlurPassDownsampleValue : 1;
                // int FinalDownsampleDivider = m_CurrentSettings.Downsample ? FinalDownsampleValue : 1;
                ...
                m_BlurPassesDescriptor.width /= downsampleDivider;   //对中间纹理进行降采样
                ...
                m_FinalDescriptor.width /= downsampleDivider;        //对中间纹理进行降采样
