...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class ScreenSpaceAmbientOcclusionEditor : Editor
    {
        ...
        // private SerializedProperty m_AOPassDownsampleValue;
        // private SerializedProperty m_BlurPassDownsampleValue;
        // private SerializedProperty m_FinalDownsampleValue;
        #endregion
        ...
        private struct Styles
        {
            ...
            // public static GUIContent AOPassDownsampleValue = EditorGUIUtility.TrTextContent("AOPass DownsampleValue", "环境光遮蔽采样率降低到原始分辨率的1/AOPassDownsampleValue,整体纹理采样率变为原来的1/(AOPassDownsampleValue^2),建议设置为2,4,8");
            // public static GUIContent BlurPassDownsampleValue = EditorGUIUtility.TrTextContent("BlurPass DownsampleValue", "模糊过程采样率降低到原始分辨率的1/BlurPassDownsampleValue,整体纹理采样率变为原来的1/(BlurPassDownsampleValue^2),建议设置为2,4,8");
            // public static GUIContent FinalDownsampleValue = EditorGUIUtility.TrTextContent("Final DownsampleValue", "最终采样率降低到原始分辨率的1/FinalDownsampleValue,整体纹理采样率变为原来的1/(FinalDownsampleValue^2),建议设置为2,4,8");
        }
        ...
        private void Init()
        {
            ...
            // m_AOPassDownsampleValue = settings.FindPropertyRelative("AOPassDownsampleValue");
            // m_BlurPassDownsampleValue = settings.FindPropertyRelative("BlurPassDownsampleValue");
            // m_FinalDownsampleValue = settings.FindPropertyRelative("FinalDownsampleValue");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // m_AOPassDownsampleValue.intValue = EditorGUILayout.IntSlider(Styles.AOPassDownsampleValue, m_AOPassDownsampleValue.intValue, 2, 8);
            // m_BlurPassDownsampleValue.intValue = EditorGUILayout.IntSlider(Styles.BlurPassDownsampleValue, m_BlurPassDownsampleValue.intValue, 2, 8);
            // m_FinalDownsampleValue.intValue = EditorGUILayout.IntSlider(Styles.FinalDownsampleValue, m_FinalDownsampleValue.intValue, 2, 8);
