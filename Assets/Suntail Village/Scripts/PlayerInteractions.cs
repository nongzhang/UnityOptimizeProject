...
namespace Suntail
{
    public class PlayerInteractions : MonoBehaviour
    {
        ...
        //     _playerInput.actions.performed += OnTap;
        // }
        private void Start()
        {
        ...
        private void Interactions()
        {
                ...
                out interactionHit, interactionDistance, interactionLayer))
            {
                if (interactionHit.collider.CompareTag(itemTag))
                {
                    ...
                    _lookObject = interactionHit.collider.GetComponent<PhysicsObject>();
                    ShowItemUI();
                }
        ...
        {
            Vector3 spherePosition = _controller.center + transform.position;
            RaycastHit legCheck;
        ...
        public void PickUpObject()
        {
            ...
            _physicsObject = _lookObject.GetComponent<PhysicsObject>();
